...
public class AdminController {
    ...
    void OnAction(ActionEvent event) {
    	...
    	if(btn==btnAnnuler) vider();
    	else {
    		if(cbxRole.getSelectionModel().isEmpty() || txtLogin.getText().isEmpty() || txtPassword.getText().isEmpty()) {
    			alerter("Tous les champs sont obligatoire", "Information",'w');
    		}else {
    			au =new Authentification(txtLogin.getText().trim(),txtPassword.getText().trim(),cbxRole.getSelectionModel().getSelectedItem().trim());
   ...
   public void chargerTabl() {
    ...
    void verifier(MouseEvent event) {
        	...
        	if(!TabUtilisateur.getSelectionModel().isEmpty()) {
        		au=new Authentification(TabUtilisateur.getSelectionModel().getSelectedItem().getId(),TabUtilisateur.getSelectionModel().getSelectedItem().getLogin(),TabUtilisateur.getSelectionModel().getSelectedItem().getPassword(),TabUtilisateur.getSelectionModel().getSelectedItem().getRole());
