...
public class AddEditController {
    ...
    void onClick(ActionEvent event) {
    	if(btnAjouter.getText().equals("Ajouter")) {
    		if(txtNom.getText().isEmpty() || txtPermi.getText().isEmpty() || txtPiece.getText().isEmpty() || txtPrenom.getText().isEmpty()) {
    		...
    		if(txtId.getText().isEmpty() || txtNom.getText().isEmpty() || txtPermi.getText().isEmpty() || txtPiece.getText().isEmpty() || txtPrenom.getText().isEmpty()) {
        		alerter("veuillez remplir les champs", "information", 'w');
        	}else {
        		cli=new Client(Integer.parseInt(txtId.getText()),txtNom.getText(),txtPrenom.getText(),txtPiece.getText(),txtPermi.getText());
